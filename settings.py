# coding=utf-8
# Django settings for lachispaadecuada project.
from os import path
...
ADMINS = (
    ('Rubén Dugo', 'rdugomartin@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'lachispaadecuada',                      # Or path to database file if using sqlite3.
...
MEDIA_URL = '/lachispaadecuada/media/'
#MEDIA_URL = 'http://media.lachispaadecuada.com'
...
ROOT_URLCONF = 'lachispaadecuada.urls'
